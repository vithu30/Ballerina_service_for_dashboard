...
string keystorePath = config:getGlobalValue("KEY_STORE_PATH");
string keystorePassword = config:getGlobalValue("KEY_STORE_PASSWORD");
string certificatePassword = config:getGlobalValue("CERT_PATH");
